...
class ProductVariations extends EditRecord
{
    ...
    protected static ?string $navigationIcon = 'elemplus-list';
    ...
    private function mergeCartesianWithExisting($variation_types, $existingData) :array
    {
        ...
        foreach ($cartesianProduct as $product){
            ...
            // Find the existing data that matches the current product combination
            $match = array_filter($existingData, function ($existingOption) use ($optionIds){
                return $existingOption['variation_type_option_ids'] === $optionIds;
            });

            // If a match is found, merge the existing data with the current product combination
            if (!empty($match)) {
            ...
            // If no match is found, use the default values
                $product['quantity'] = $defaultQuantity;
                $product['price'] = $defaultPrice;
            }
            // Add the current product combination to the merged result
    ...
    private function cartesianProduct($variationTypes, $defaultQuantity = null, $defaultPrice = null) :array
    {
        ...
        // Check if $variationTypes is null or empty
        if (empty($variationTypes)) {
        // Return an empty array if there are no variation types
        return [];
        }
    ...
    protected function mutateFormDataBeforeSave(array $data): array
    {
        ...
        // dd($this->record->variation_types);
